 ...
 * `@poseidon/contracts/rpc` stays the one place a caller imports it from.
 */
 ...
 */
export class PoseidonRpcError extends Schema.TaggedError<PoseidonRpcError>()("PoseidonRpcError", {
