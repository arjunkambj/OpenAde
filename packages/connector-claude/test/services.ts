 ...
 * permission ladder that answers one fixed verdict, an MCP endpoint nothing
...
export const testServices = (
  options: { readonly decision?: PermissionDecision } = {},
  ...
  Effect.clockWith((clock) =>
    Effect.sync((): ConnectorServices => ({
      ...
      permissions: { decide: () => Effect.succeed(options.decision ?? "prompt") },
