/**
 * One `ItemSnapshot` → one row component, plus the synthetic rows: a settled
 * turn's `turn-fold`, `work-group` folds, the `turn-summary` card, `decision`
 * records and the `working` indicator.
